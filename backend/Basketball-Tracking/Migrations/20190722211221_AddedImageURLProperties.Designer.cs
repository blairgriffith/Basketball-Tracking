...
namespace BasketballTracking.Migrations
{
    ...
    [Migration("20190722211221_AddedImageURLProperties")]
    partial class AddedImageURLProperties
    {
            ...
            modelBuilder.Entity("BasketballTracking.Models.Team", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { TeamId = 5, ConferenceId = 2, ImageURL = "https://stats.nba.com/media/img/teams/logos/GSW_logo.svg", Location = "San Francisco", Name = "Warriors" }
                    );
                });
